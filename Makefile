...
proto-gen:
	...
	$(DOCKER) run --rm -v $(CURDIR):/workspace -v $(CURDIR)/../cosmos-sdk:/cosmos-sdk -v $(CURDIR)/../gravity-bridge:/gravity-bridge --workdir /workspace tendermintdev/sdk-proto-gen:v0.2 sh ./scripts/protocgen.sh
