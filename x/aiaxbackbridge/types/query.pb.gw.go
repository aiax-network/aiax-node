...
var (
	pattern_Query_ContractInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"aiaxbackbridge", "v1", "contract"}, "", runtime.AssumeColonVerbOpt(true)))
)
