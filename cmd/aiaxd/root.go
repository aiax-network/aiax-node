...
func (a appCreator) appExport(
	...
	if height != -1 {
		aapp = app.NewAiax(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
		if err := aapp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		aapp = app.NewAiax(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
